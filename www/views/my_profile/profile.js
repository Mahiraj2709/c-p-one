angular.module('starter')
    .controller('ProfileCtrl', function ($scope, $rootScope, $http,GooglePlacesService, $ionicLoading, $ionicPopup, ImagePickerService,UploadVideo,
                                         $location,$timeout,$cordovaCamera, $cordovaGeolocation, CONSTANTS,UploadImageService, LoadImagesService) {
        var imgPosition = -1;
